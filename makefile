...
data/intersection_annotation_svs: data/intersection_annotation data/1KG_phase3_all_bkpts.v5.txt
	join -1 6 -2 4 <(sort -k6,6 data/intersection_annotation) <(sort -k4,4 data/1KG_phase3_all_bkpts.v5.txt) | awk '{print $$2"\t"$$3"\t"$$4"\t"$$5"\t"$$6"\t"$$1"\t"$$10}' > data/intersection_annotation_svs
